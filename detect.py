...
ap.add_argument('-c', '--config', 
                help = 'path to yolo config file', default='custom/yolov3-tiny.cfg')
ap.add_argument('-w', '--weights', 
                help = 'path to yolo pre-trained weights', default='backup/yolov3-tiny_20000.weights')
ap.add_argument('-cl', '--classes', 
                help = 'path to text file containing class names',default='custom/objects.names')
args = ap.parse_args()
...
window_title= "Mitochondria Detector"   
